...
**Usefy** — это полнофункциональное веб-приложение для управления образовательными заявками и курсами, реализованное на Spring Boot. Проект демонстрирует навыки backend- и frontend-разработки в рамках единого MVC-приложения.
